...
export const addtodownloads=(downloadsdata)=>API.post('/video/downloads',downloadsdata)
export const getalldownloads=()=>API.get('/video/getalldownloads')
export const deletedownloads=(videoid,viewer)=>API.delete(`/video/deletedownloads/${videoid}/${viewer}`)