...
import {downloadscontroller,getalldownloadsvontroller,deletedownloads} from '../Controllers/downloads.js'
...
routes.post('/downloads',auth,downloadscontroller)
routes.get('/getalldownloads',getalldownloadsvontroller)
routes.delete('/deletedownloads/:videoid/:viewer',auth,deletedownloads)
